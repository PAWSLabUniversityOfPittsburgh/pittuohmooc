...
javac -d "./java/source_codes/progMooc/classes" "./java/source_codes/progMooc/src/progMooc/BehavLbl_PS4.java"
for dataset in ${datasets[@]} # for all datasets
do
    # remove if file exists
    rm -f "../data/${dataset}_behavLbl_log_PS4.txt"
    rm -f "../data/${dataset}_all_behavLbl.txt"
    # create an empty file for storing warnings generated during the labeling process
    echo "" > "../data/${dataset}_behavLbl_log_PS4.txt"
    #running the behaviour labeling java file
    java -cp "./java/source_codes/progMooc/classes/" progMooc.BehavLbl_PS4 "../data/${dataset}_all.txt" "../data/${dataset}_all_behavLbl.txt" $dataset >>  "../data/${dataset}_behavLbl_log_PS4.txt"
...
do
    ...
    cp -f "../temp_behav/${dataset}_all.txt" "../data/${dataset}_all_PS4.txt" # repalace the original dataset file with the dataset merged with behaviour labels
done # for all datasets
...
do
    rm -rf ../data/${dataset}_allsubmit_behav_PS4.txt
    fname="../data/${dataset}_all_PS4.txt"
    grep -v ";GENERIC;" "${fname}" >> ../data/${dataset}_allsubmit_behav_PS4.txt
    wc -l ../data/${dataset}_all_PS4.txt
    wc -l ../data/${dataset}_allsubmit_behav_PS4.txt
done # all datasets
# 133370 ../data/s2014-ohpe_all_PS4.txt
# 107143 ../data/s2014-ohpe_allsubmit_behav_PS4.txt
# 115560 ../data/s2015-ohpe_all_PS4.txt
# 92591 ../data/s2015-ohpe_allsubmit_behav_PS4.txt
# 338685 ../data/k2015-mooc_all_PS4.txt
# 274456 ../data/k2015-mooc_allsubmit_behav_PS4.txt
# 418890 ../data/k2014-mooc_all_PS4.txt
# 340206 ../data/k2014-mooc_allsubmit_behav_PS4.txt
