...
do
	...
	lldata=${prefixR}/data/${dataset}_liblineardata/${dataset}_allsubmit_llTFMtimePS12.txt
	llmodel=${prefixR}/model/${dataset}_allsubmit_llTFMtimePS12_model${costtag}.txt
	llpredict=${prefixR}/predict/${dataset}_allsubmit_llTFMtimePS12_predict${costtag}.txt
	llout=${prefixR}/out/${dataset}_allsubmit_llTFMtimePS12_out${costtag}.txt
